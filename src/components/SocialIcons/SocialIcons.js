...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        ...
        {/*<a target="_blank" rel="noopener noreferrer" href="#" style={ { color: colorPrimary } }><i id="coinwidget" className="fab fa-btc" data-icon="true" data-type="primary" data-wallet="34cUdCZ3fVMA7TcTFexpayXKCkTxtLv6sr" /></a>*/}
      </div>
  );
};
